...
import { CrearEditarModulosType, GuardarModulosType } from "../types/CrearEditarModulosType"
import { FormInputDropdown, optionType } from "@/components/form/FormInputDropdown"
    ...
    const guardarActualizarModuloPeticion = async (
        ...
        try {
            ...
            const respuesta = await sesionPeticion({
                url: `${Constantes.baseUrl}/autorizacion/modulos${modulo.id ? `/${modulo.id}` : ''}`,
