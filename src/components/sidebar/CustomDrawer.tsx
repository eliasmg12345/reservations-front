...
import { Drawer, SxProps, Toolbar, Box, Theme, Tooltip, Typography, Collapse, List, ListItemButton, Icon, Divider } from "@mui/material";
import { ReactNode } from "react";
import { Icono } from "../Icono";
import CustomBadge from "../CustomBadge";
import { versionNumber } from "@/utils/utilidades";
...
export const CustomDrawer = ({
    ...
    const rutaActiva = (routeName: string, currentRoute: string) => currentRoute.includes(routeName, 0)
